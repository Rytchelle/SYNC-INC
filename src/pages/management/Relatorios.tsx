      ...
      <main className="flex-1 w-full px-4 md:px-10 py-8 flex flex-col items-center bg-gradient-to-br from-[var(--bg)] via-[var(--accent)] to-[var(--primary)/10] fade-in">
        <div className="w-full max-w-7xl">
          <PageHeader 
            ...
            subtitle="Análise detalhada de dados e performance para gestão"
          />
              ...
              <Card className="shadow-lg border-0 bg-gradient-to-br from-white to-[var(--accent)]">
                <CardContent className="p-6">
                  ...
                  <div className="space-y-4">
                    {getReportData().slice(0, 4).map((item, index) => (
                      <div key={index} className="flex justify-between items-center p-3 bg-white rounded-lg shadow-sm border border-gray-100">
                        <div>
                          <p className="font-medium text-[var(--text)]">{getItemDisplayName(item)}</p>
                          <p className="text-xs text-[var(--muted)]">{getItemDescription(item)}</p>
                        </div>
                        <div className="text-right">
                          <p className="font-bold text-[var(--primary)]">{getItemValue(item)}</p>
                          <p className="text-xs text-[var(--muted)]">{getItemSubValue(item)}</p>
                        </div>
                      </div>
                    ))}
                  </div>
